...
public class Ambiance_ThemeContainer : ContainerControl
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        G.DrawRectangle(new Pen(Color.FromArgb(45,45,45)), new Rectangle(0, 0, Width - 1, Height - 1));
        // Use [Color.FromArgb(87, 86, 81), Color.FromArgb(60, 59, 55)] for a darker taste
        // And replace each (60, 59, 55) with (69, 68, 63)
        G.FillRectangle(new LinearGradientBrush(new Point(0, 0), new Point(0, 36), Color.FromArgb(45,45,45), Color.FromArgb(45,45,45)), new Rectangle(1, 1, Width - 2, 36));
        G.FillRectangle(new LinearGradientBrush(new Point(0, 0), new Point(0, Height), Color.FromArgb(45, 45, 45), Color.FromArgb(45, 45, 45)), new Rectangle(1, 36, Width - 2, Height - 46));

        G.DrawRectangle(new Pen(Color.FromArgb(30, 30, 30)), new Rectangle(9, 47, Width - 19, Height - 55));
        G.FillRectangle(new SolidBrush(Color.FromArgb(30, 30, 30)), new Rectangle(10, 48, Width - 20, Height - 56));
        ...
        if (_RoundCorners == true)
        {
            ...
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), 1, 3, 1, 1);
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), 1, 2, 1, 1);
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), 2, 1, 1, 1);
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), 3, 1, 1, 1);
            ...
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), Width - 2, 3, 1, 1);
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), Width - 2, 2, 1, 1);
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), Width - 3, 1, 1, 1);
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), Width - 4, 1, 1, 1);
            ...
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), 1, Height - 3, 1, 1);
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), 1, Height - 4, 1, 1);
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), 3, Height - 2, 1, 1);
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), 2, Height - 2, 1, 1);
            ...
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), Width - 2, Height - 3, 1, 1);
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), Width - 2, Height - 4, 1, 1);
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), Width - 4, Height - 2, 1, 1);
            G.FillRectangle(new SolidBrush(Color.FromArgb(45,45,45)), Width - 3, Height - 2, 1, 1);
        }

        G.DrawString(Text, new Font("Tahoma", 12, FontStyle.Bold), new SolidBrush(Color.FromArgb(45, 45, 45)), new Rectangle(0, 14, Width - 1, Height), new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Near });
    }
}
...
public class Ambiance_ControlBox : Control
{
    ...
    protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
    {
        ...
        LinearGradientBrush LGBClose = new LinearGradientBrush(CloseBtn, Color.Green, Color.Green, 90);
        G.FillEllipse(LGBClose, CloseBtn);
        G.DrawEllipse(new Pen(Color.FromArgb(57, 56, 53)), CloseBtn);
       // G.DrawString("0", new Font("Marlett", 7), new SolidBrush(Color.FromArgb(52, 50, 46)), new Rectangle((int)6.5, 8, 0, 0));

        LinearGradientBrush LGBMinimize = new LinearGradientBrush(MinBtn, Color.Red, Color.Red, 90);
        G.FillEllipse(LGBMinimize, MinBtn);
        G.DrawEllipse(new Pen(Color.FromArgb(57, 56, 53)), MinBtn);
       // G.DrawString("r", new Font("Marlett", 7), new SolidBrush(Color.FromArgb(52, 50, 46)), new Rectangle(26, (int)4.4, 0, 0));
        ...
        switch (State)
        {
            ...
            //    LinearGradientBrush xLGBClose_1 = new LinearGradientBrush(CloseBtn, Color.FromArgb(255, 255, 255), Color.FromArgb(255, 255, 255), 90);
            //    //G.FillEllipse(xLGBClose_1, CloseBtn);
            //    G.DrawEllipse(new Pen(Color.FromArgb(45, 45, 45)), CloseBtn);
            //    G.DrawString("r", new Font("Marlett", 7), new SolidBrush(Color.FromArgb(45, 45, 45)), new Rectangle((int)6.5, 8, 0, 0));

            //    LinearGradientBrush xLGBMinimize_1 = new LinearGradientBrush(MinBtn, Color.FromArgb(45, 45, 45), Color.FromArgb(45, 45, 45), 90);
            //   // G.FillEllipse(xLGBMinimize_1, MinBtn);
            //    G.DrawEllipse(new Pen(Color.FromArgb(45, 45, 45)), MinBtn);
            //    G.DrawString("0", new Font("Marlett", 7), new SolidBrush(Color.FromArgb(45, 45, 45)), new Rectangle(26, (int)4.4, 0, 0));
            ...
            //    //    G.DrawEllipse(new Pen(Color.FromArgb(83,161,226)), MaxBtn);
            //    //    G.DrawString("1", new Font("Marlett", 7), new SolidBrush(Color.FromArgb(52, 50, 46)), new Rectangle(46, 7, 0, 0));
            //    //}
            //    break;
            ...
            //    if (X > 3 && X < 20)
            //    {
            //        LinearGradientBrush xLGBClose = new LinearGradientBrush(CloseBtn, Color.FromArgb(255, 255, 255), Color.FromArgb(255, 255, 255), 90);
            ...
            //    else if (X > 23 && X < 40)
            //    {
            //        LinearGradientBrush xLGBMinimize = new LinearGradientBrush(MinBtn, Color.FromArgb(255, 255, 255), Color.FromArgb(255, 255, 255), 90);
            //        //G.FillEllipse(xLGBMinimize, MinBtn);
            //        G.DrawEllipse(new Pen(Color.FromArgb(45, 45, 45)), MinBtn);
            //        G.DrawString("0", new Font("Marlett", 7), new SolidBrush(Color.FromArgb(255, 255, 255)), new Rectangle(26, (int)4.4, 0, 0));
            //    }
            //    else if (X > 43 && X < 60)
            //    {
            //        //if (_EnableMaximize == true)
...
public class Ambiance_ProgressBar : Control
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        GB1 = new LinearGradientBrush(R1, Color.FromArgb(45,45,45), Color.FromArgb(230, 230, 230), 90f);
...
class Ambiance_ProgressIndicator : Control
{
    ...
    private readonly SolidBrush AnimationColor = new SolidBrush(Color.FromArgb(76, 76, 76));
...
class Ambiance_CheckBox : Control
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        if (Checked)
        {
            MyDrawer.DrawString("ü", new Font("Wingdings", 12), new SolidBrush(Color.FromArgb(45,45,45)), new Rectangle(-2, 1, Width, Height + 2), new StringFormat { LineAlignment = StringAlignment.Center });
        }
        e.Dispose();
    }
}
...
class Ambiance_RadioButton : Control
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        if (_Checked)
        {
            SolidBrush EllipseColor = new SolidBrush(Color.FromArgb(45,45,45));
...
public class Ambiance_TabControl : TabControl
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        for (int TabIndex = 0; TabIndex <= TabCount - 1; TabIndex++)
        {
            ...
            {
                G.DrawString(TabPages[TabIndex].Text, new Font(Font.Name, Font.Size - 1, FontStyle.Bold), new SolidBrush(Color.FromArgb(83,161,226)), new Rectangle(GetTabRect(TabIndex).Location, GetTabRect(TabIndex).Size), new StringFormat
                {
                    LineAlignment = StringAlignment.Center,
                    Alignment = StringAlignment.Center
                });
        ...
        G.FillPath(new SolidBrush(Color.FromArgb(30, 30, 30)), RoundRectangle.RoundRect(0, 23, Width - 1, Height - 24, 2));
        G.DrawPath(new Pen(Color.FromArgb(30, 30, 30)), RoundRectangle.RoundRect(0, 23, Width - 1, Height - 24, 2));
        ...
        for (int ItemIndex = 0; ItemIndex <= TabCount - 1; ItemIndex++)
        {
            ...
            if (ItemIndex == SelectedIndex)
            {
                ...
                // Draw header tabs
                G.DrawPath(new Pen(Color.FromArgb(30, 30, 30)), RoundRectangle.RoundedTopRect(new Rectangle(new Point(ItemBoundsRect.X - 2, ItemBoundsRect.Y - 2), new Size(ItemBoundsRect.Width + 3, ItemBoundsRect.Height)), 7));
                G.FillPath(new SolidBrush(Color.FromArgb(30, 30, 30)), RoundRectangle.RoundedTopRect(new Rectangle(new Point(ItemBoundsRect.X - 1, ItemBoundsRect.Y - 1), new Size(ItemBoundsRect.Width + 2, ItemBoundsRect.Height)), 7));

                try
                {
                    G.DrawString(TabPages[ItemIndex].Text, new Font(Font.Name, Font.Size - 1, FontStyle.Bold), new SolidBrush(Color.FromArgb(255,255,255)), new Rectangle(GetTabRect(ItemIndex).Location, GetTabRect(ItemIndex).Size), new StringFormat
                    {
                        LineAlignment = StringAlignment.Center,
                        Alignment = StringAlignment.Center
                    });
                    TabPages[ItemIndex].BackColor = Color.FromArgb(30, 30, 30);
                }
                catch
                {
                }
